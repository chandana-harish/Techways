...
const VerifyEmail = () => {
    ...
    useEffect(() => {
        ...
        const checkVerificationAndSendOtp = async () => {
            try {
                ...
                const infoRes = await axios.get("http://13.233.99.93:8080/auth/get-my-info", { headers });
    ...
    const sendOtp = async (emailToSend) => {
        try {
            setLoading(true);
            const res = await axios.post("http://13.233.99.93:8080/auth/email/send-otp", { email: emailToSend });
    ...
    const handleOtpSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post("http://13.233.99.93:8080/auth/email/verify", payload, {
                validateStatus: () => true,
            });
